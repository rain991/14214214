class ShipBullet extends Entity implements BulletMoving, HitObjectCallback, EndGameCallback {
    public ShipBullet(int positionX, int positionY,int gameSpaceHeight, Entity[][] gameSpace) {
